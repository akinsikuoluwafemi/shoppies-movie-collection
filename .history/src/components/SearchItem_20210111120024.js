    ...
    return (
        <ul  className="list">
            <li className="list-item">
                ...
                {/* disabled */}
                {nominate ? (
                <button className={nominated ? `btn btn-outline-success disabled` : `btn btn-outline-success`}>Nominate</button>
                    
                ): (
                <button onClick={nominateMovie} className={nominated ? `btn btn-outline-success disabled` : `btn btn-outline-success`}>Nominate</button>
